---
domain: ORM
packages: EntityFramework.Core, EntityFramework, EntityFramework.CommitCoordination, EntityFramework.Messaging, Couchbase, MultiTenancy
---
...
1. Captured Domain occurrences drained via `ILocalEventBus` to quiescence, followed by final audit capture (before business save)
