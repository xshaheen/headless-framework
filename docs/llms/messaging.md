...
| `Intent`            | `headless-intent`              | yes      | framework    | Delivery intent stamped by the framework so bus/queue semantics survive publish, storage, and consume.  |
