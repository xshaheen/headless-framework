...
- **`Headless.Constants`** — `RegexPatterns`, `ContentTypes`, `HttpHeaderNames`, `JwtClaimTypes`, `UserClaimTypes`, `LanguageCodes`, `AuthenticationConstants`, `EnvironmentNames`/`EnvironmentVariables`, `HeadlessDiagnostics`, `StorageIdentifier`, `StorageProvider`, `TimezoneConstants`.
