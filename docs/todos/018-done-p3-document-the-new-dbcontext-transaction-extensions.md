...
- [x] Each public ExecuteTransactionAsync extension overload has XML docs
- [x] Relevant package docs mention how to use the transaction helpers after the refactor
- [x] If the move is intended as a migration, the docs call that out explicitly
