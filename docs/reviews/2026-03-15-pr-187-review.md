...
Reviewed PR #187 against `origin/main`. The main risks are incorrect audit identities for store-generated keys, incorrect `DbContext` binding in multi-context applications, and a SQLite portability gap in the default schema mapping.
