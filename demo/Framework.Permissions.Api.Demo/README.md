# Framework.Permissions.Api.Demo
...
```bash
cd demo/Framework.Permissions.Api.Demo
dotnet run
```
...
- IPermissionManager: `src/Framework.Permissions.Abstractions/Grants/IPermissionManager.cs`
- IPermissionDefinitionManager: `src/Framework.Permissions.Abstractions/Definitions/IPermissionDefinitionManager.cs`
