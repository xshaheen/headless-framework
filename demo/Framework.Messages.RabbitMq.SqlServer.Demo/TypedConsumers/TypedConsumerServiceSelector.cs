...
internal class TypedConsumerServiceSelector(IServiceProvider serviceProvider) : ConsumerServiceSelector(serviceProvider)
{
    ...
    {
        var method = typeInfo.DeclaredMethods.FirstOrDefault(x =>
            string.Equals(x.Name, "Handle", StringComparison.Ordinal)
        );
        ...
        foreach (var attr in topicAttributes)
        {
            ...
            var parameters = method
                ...
                .Select(p => new ParameterDescriptor
                {
                    ...
                    IsFromCap = p.GetCustomAttributes<FromCapAttribute>().Any(),
                })
                .ToList();
            ...
            {
                Attribute = new CapSubscribeAttribute(capName) { Group = topic },
