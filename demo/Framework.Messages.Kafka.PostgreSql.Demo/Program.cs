...
builder
    ...
    {
        messaging.Consumer<KafkaMessageConsumer>().Topic("sample.kafka.postgrsql").Build();
        messaging.WithTopicMapping<KafkaMessage>("sample.kafka.postgrsql");
    })
    .AddCap(x =>
    {
...
public static class AppConstants
{
    public const string DbConnectionString =
        "User ID=postgres;Password=mysecretpassword;Host=127.0.0.1;Port=5432;Database=postgres;";
}
