...
**Approach:** Add validation to Schema property setter.
    ...
    set
    {
        ...
        if (!Regex.IsMatch(value, @"^[a-zA-Z_][a-zA-Z0-9_]*$"))
            throw new ArgumentException(
                "Schema name must contain only alphanumeric characters and underscores, starting with a letter or underscore",
                nameof(value));
