    ...
    where TTimeTicker : TimeTickerEntity<TTimeTicker>, new()
{
    ...
    private TTimeTicker _CreateGrandChild(TTimeTicker parent)
    {
        return new TTimeTicker
        {
            Id = Guid.NewGuid(),
    ...
    public class SecondChildBuilder
    {
        ...
        internal SecondChildBuilder(
            FluentChainTickerBuilder<TTimeTicker> mainBuilder,
            TTimeTicker child,
            int childIndex
        )
        {
...
public static class FluentChainTickerBuilderExtensions
{
    ...
    /// </summary>
    public static FluentChainTickerBuilder<TTimeTicker> BeginWith<TTimeTicker>(
