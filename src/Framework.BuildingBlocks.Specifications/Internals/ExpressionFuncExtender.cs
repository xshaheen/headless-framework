...
namespace Framework.BuildingBlocks.Specifications.Internals;
...
public static class ExpressionFuncExtender
{
    ...
    /// <summary>Combines two given expressions by using the AND semantics.</summary>
    ...
    {
        return first._Compose(second, Expression.AndAlso);
    }

    /// <summary>Combines two given expressions by using the OR semantics.</summary>
    /// <typeparam name="T">The type of the object.</typeparam>
    /// <param name="first">The first part of the expression.</param>
    /// <param name="second">The second part of the expression.</param>
    /// <returns>The combined expression.</returns>
    ...
    {
        return first._Compose(second, Expression.OrElse);
    }
}
