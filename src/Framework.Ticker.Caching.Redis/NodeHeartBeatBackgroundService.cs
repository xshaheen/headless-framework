using Framework.Ticker.Caching.StackExchangeRedis.DependencyInjection;
using Framework.Ticker.Utilities.Interfaces;
using Framework.Ticker.Utilities.Interfaces.Managers;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Logging;

namespace Framework.Ticker.Caching.StackExchangeRedis;
...
internal class NodeHeartBeatBackgroundService : BackgroundService
{
    ...
    public NodeHeartBeatBackgroundService(
        ServiceExtension.TickerQRedisOptionBuilder schedulerOptionsBuilder,
        ITickerQRedisContext context,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        try
        {
            await _RunTickerQFallbackAsync(stoppingToken);
        }
        catch (Exception e)
        {
    ...
    private async Task _RunTickerQFallbackAsync(CancellationToken stoppingToken)
    {
