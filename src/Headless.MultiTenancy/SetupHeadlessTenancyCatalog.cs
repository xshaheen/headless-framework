...
public static class SetupHeadlessTenancyCatalog
{
    ...
    /// (<c>UseInMemory</c> today; <c>UseConfiguration</c> / <c>UseEntityFramework</c> land in later
    /// units), the catalog service, the <see cref="ICurrentTenantInfo"/> accessor, and posture recording.
    /// </summary>
