...
/// <summary>
/// Default implementation of <c>IJobsInstrumentation</c>: logs every job lifecycle event and, when a
/// listener is attached to <see cref="JobsDiagnostics.SourceName"/>, also emits it as an
/// <see cref="Activity"/> span. <see cref="JobsDiagnostics.Start"/> returns <see langword="null"/> with no
