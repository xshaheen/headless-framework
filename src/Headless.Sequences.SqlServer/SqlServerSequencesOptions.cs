...
public sealed class SqlServerSequencesOptions
{
    ...
    /// same database, so name the database explicitly (<c>Initial Catalog</c>). Required.
    /// </summary>
...
internal sealed class SqlServerSequencesOptionsValidator : AbstractValidator<SqlServerSequencesOptions>
{
    public SqlServerSequencesOptionsValidator()
    {
