...
public static partial class RegularLockLoggerExtensions
{
    ...
    public static partial void LogRenewingLock(this ILogger logger, string resource, string leaseId, TimeSpan? duration);
    ...
    public static partial void LogDelayBeforeRetry(this ILogger logger, string resource, string leaseId, TimeSpan delay);
