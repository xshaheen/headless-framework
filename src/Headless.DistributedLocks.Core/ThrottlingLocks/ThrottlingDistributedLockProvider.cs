...
[PublicAPI]
public sealed class ThrottlingDistributedLockProvider(
    IThrottlingDistributedLockStorage storage,
    ThrottlingDistributedLockOptions options,
    TimeProvider timeProvider,
    ILogger<ThrottlingDistributedLockProvider> logger
) : IThrottlingDistributedLockProvider, IHaveTimeProvider, IHaveLogger
{
    ...
    public async Task<IDistributedThrottlingLock?> TryAcquireAsync(
        string resource,
    ...
    )
    {
        ...
        return new DistributedThrottlingLock(resource, elapsed, timeProvider.GetUtcNow());
    }
