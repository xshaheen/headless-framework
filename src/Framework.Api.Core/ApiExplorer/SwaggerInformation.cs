...
public static class SwaggerInformation
{
    ...
    public const string ResponsesDescription = """
        <details>
        <summary>Api Status Codes</summary>
        ...
        - **404 Not Found**
            ...
            is entirely invalid (i.e. /request), or if it is a URL that could be valid but
            is referencing something that does not exist (i.e. /items/12344).
