...
```bash
dotnet add package Framework.Messages.Abstractions
```
...
- `Framework.Messages.Core` (base implementation)
- Transport packages: `Framework.Messages.RabbitMQ`, `Framework.Messages.Kafka`, etc.
- Storage packages: `Framework.Messages.PostgreSql`, `Framework.Messages.SqlServer`, etc.
