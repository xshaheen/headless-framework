...
[System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "MA0049:Type name should not match containing namespace")]
internal class ObjectMethodExecutor
{
    ...
    private ObjectMethodExecutor(MethodInfo methodInfo, TypeInfo targetTypeInfo, object?[]? parameterDefaultValues)
    {
        ...
        _executor = _GetExecutor(methodInfo, targetTypeInfo);

        if (IsMethodAsync)
        {
            _executorAsync = _GetExecutorAsync(methodInfo, targetTypeInfo, coercedAwaitableInfo);
        }
    ...
    {
        Argument.IsNotNull(parameterDefaultValues);
    ...
    private static MethodExecutor _GetExecutor(MethodInfo methodInfo, TypeInfo targetTypeInfo)
    {
        ...
        if (methodCall.Type == typeof(void))
        {
            ...
            return _WrapVoidMethod(voidExecutor);
        }
        else
        {
    ...
    private static MethodExecutor _WrapVoidMethod(VoidMethodExecutor executor)
    {
    ...
    private static MethodExecutorAsync _GetExecutorAsync(
        MethodInfo methodInfo,
        TypeInfo targetTypeInfo,
