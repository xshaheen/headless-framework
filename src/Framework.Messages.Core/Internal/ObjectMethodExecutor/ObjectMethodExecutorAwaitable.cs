...
)
{
    ...
    {
        var customAwaiter = getAwaiterMethod(customAwaitable);
        return new Awaiter(
            customAwaiter,
            isCompletedMethod,
            getResultMethod,
    ...
    ) : ICriticalNotifyCompletion
    {
        ...
        {
            return getResultMethod(customAwaiter);
        }

        public void OnCompleted(Action continuation)
        {
            onCompletedMethod(customAwaiter, continuation);
        }
        ...
        public void UnsafeOnCompleted(Action continuation)
        {
            ...
            var underlyingMethodToUse = unsafeOnCompletedMethod ?? onCompletedMethod;
            underlyingMethodToUse(customAwaiter, continuation);
        }
    }
}
