...
public sealed class HeadlessSettingsSetupBuilder
{
    ...
    /// <summary>
    /// Binds the shared <see cref="SettingsStorageOptions"/> from <paramref name="configuration"/>; pass the
    /// <c>Headless:Settings:Storage</c> section. Applied immediately, in call order with the delegate overload.
    /// </summary>
    ...
    public HeadlessSettingsSetupBuilder ConfigureStorage(IConfiguration configuration)
    {
