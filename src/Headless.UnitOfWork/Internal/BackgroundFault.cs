...
/// <summary>
/// Observes a task nobody awaits so its fault is logged instead of becoming an unobserved-task exception,
/// without paying for a continuation when the work already completed successfully.
/// </summary>
