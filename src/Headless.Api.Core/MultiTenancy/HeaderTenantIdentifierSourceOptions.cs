...
/// <summary>
/// Options for the header tenant identifier source (R3, R7): the request header names read, in
...
/// <summary>Validator for <see cref="HeaderTenantIdentifierSourceOptions"/> (R7).</summary>
