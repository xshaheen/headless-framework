...
/// </summary>
/// <remarks>
/// Templates follow the grammar owned by <c>HostTemplate</c>: <c>{tenant}</c> captures
...
/// docs. Options contributions accumulate across <c>AddHostSource</c> calls, so the string
/// convenience overload appends to this list rather than replacing it.
/// </remarks>
[PublicAPI]
...
/// <summary>Validator for <see cref="HostTenantIdentifierSourceOptions"/>.</summary>
internal sealed class HostTenantIdentifierSourceOptionsValidator : AbstractValidator<HostTenantIdentifierSourceOptions>
{
    public HostTenantIdentifierSourceOptionsValidator()
    {
        ...
        // verbatim gives the operator the exact fix.
