...
/// resolution resolves an enabled tenant. Carries the identifier-resolved canonical tenant id so
/// identifier/claim mismatch integrity enforcement (<c>TenantIdentifierIntegrityHandler</c>, and the claim-resolution fast path in
