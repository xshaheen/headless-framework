...
/// canonical tenant id does not match the authenticated principal's tenant claim.
/// <c>StatusCodesRewriterMiddleware</c> reads this feature on a bare 403 response to substitute the
/// mismatch ProblemDetails body — generic (404, <c>g:tenant_resolution_failed</c>) by default, or
