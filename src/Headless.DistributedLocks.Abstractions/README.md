...
- Lock inspection methods for current lease id, expiration, active count, active list, and lock info. `GetLeaseIdAsync` does not renew a lease; monitored holders should use `LostToken` for lease-loss observation.
