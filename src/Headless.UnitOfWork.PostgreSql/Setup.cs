...
/// <summary>
/// Registers the PostgreSQL unit-of-work provider.
/// </summary>
[PublicAPI]
public static class SetupPostgreSqlUnitOfWork
{
    extension(IServiceCollection services)
    {
        /// <summary>
        /// Adds the singleton unit-of-work factory the Npgsql helpers (<c>BeginAsync(connection)</c>,
        ...
        public IServiceCollection AddPostgreSqlUnitOfWork()
        {
