...
/// <summary>Provides a set of extension methods for operations on <see cref="Array"/>.</summary>
[PublicAPI]
public static class ArrayExtensions
{
    ...
    /// <summary>
    /// Sorts the elements in an entire <see cref="Array" /> using the specified <see cref="Comparison{T}" />.
    /// </summary>
    ///
    /// <typeparam name="T">The type of the elements of the array.</typeparam>
    /// <param name="array">The one-dimensional, zero-based <see cref="Array" /> to sort.</param>
