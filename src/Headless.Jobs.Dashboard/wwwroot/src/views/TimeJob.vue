...
onUnmounted(() => {
  JobNotificationHub.stopReceiver(methodName.onReceiveAddTimeJob)
...
const addHubListeners = async () => {
  ...
  JobNotificationHub.onReceiveAddTimeJob<GetTimeJobResponse>(() => {
    debouncedRefresh()
  })

  JobNotificationHub.onReceiveUpdateTimeJob<void>(() => {
    debouncedRefresh()
  })
  ...
  JobNotificationHub.onReceiveAddTimeJobsBatch(() => {
    loadPageData()
