...
{
    /// <summary>
    /// Sends a single notification to one device identified by its provider-issued client identifier.
    /// </summary>
    /// <param name="clientIdentifier">The device identifier issued by the push provider.</param>
