...
public interface ILocalEventBus
{
    ...
    /// synchronization context (classic ASP.NET, Blazor Server, WPF), or it may deadlock; prefer <c>PublishAsync</c>
    ...
    /// <remarks>Sync-over-async; see <c>Publish&lt;T&gt;</c> for the synchronization-context deadlock caveat.</remarks>
