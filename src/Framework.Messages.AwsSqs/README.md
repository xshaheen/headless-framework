...
- **Dead Letter[Framework.Messages.AwsSqs.csproj](Framework.Messages.AwsSqs.csproj) Queues**: Built-in failure handling
- **IAM Integration**: Automatic policy configuration

## Installation

```bash
dotnet add package Framework.Messages.AmazonSqs
```
