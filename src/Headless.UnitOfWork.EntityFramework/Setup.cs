...
public static class SetupEntityFrameworkUnitOfWork
{
    ...
    {
        /// <summary>
        /// Adds the EF Core unit-of-work provider: the scoped <see cref="IUnitOfWorkManager" /> plus the
        ...
        /// composition with other provider registrations leave exactly one manager in the container. There
