...
#endif
{
    ...
    /// <summary>Initializes a new instance of the <see cref="Money"/> class by validating the specified <see cref="decimal"/> value using <see cref="Validate"/> static method.</summary>
    /// <param name="value">The value to be validated.</param>
    public Money(decimal value) : this(value, true) { }

    private Money(decimal value, bool validate) 
    {
        if (validate)
        {
...
#pragma warning restore AL1003
    ...
    /// <param name="value">The value to create Money from</param>
    /// <param name="result">When this method returns, contains the created Money if the conversion succeeded, or null if the conversion failed.</param>
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(decimal value, [NotNullWhen(true)] out Money? result)
    {
    ...
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(decimal value,[NotNullWhen(true)]  out Money? result, [NotNullWhen(false)]  out string? errorMessage)
    {
    ...
    public int CompareTo(object? obj)
    {
        return obj switch
        {
            null => 1,
            Money c => CompareTo(c),
            _ => throw new ArgumentException("Object is not a Money", nameof(obj)),
        };
    }
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Money Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => decimal.Parse(s, provider);
    ...
    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out Money result) => TryParse(s is null ? [] : s.AsSpan(), provider, out result);
    ...
    /// <summary>Implicit conversion from <see cref = "decimal"/> to <see cref = "Money"/></summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Money(decimal value) => new(value);

    /// <summary>Implicit conversion from <see cref = "decimal"/> (nullable) to <see cref = "Money"/> (nullable)</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator Money?(decimal? value) => value is null ? null : new(value.Value);

    /// <summary>Implicit conversion from <see cref = "Money"/> to <see cref = "decimal"/></summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator decimal(Money value) => (decimal)value._valueOrThrow;

    /// <summary>Implicit conversion from <see cref = "Money"/> (nullable) to <see cref = "decimal"/> (nullable)</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator decimal?(Money? value) => value is null ? null : (decimal?)value.Value._valueOrThrow;
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Money operator +(Money left, Money right) => new(left._valueOrThrow + right._valueOrThrow);
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(Money left, Money right) => left._valueOrThrow < right._valueOrThrow;
