...
/// <summary>TypeConverter for <see cref = "Money"/></summary>
public sealed class MoneyTypeConverter : DecimalConverter
{
    /// <inheritdoc/>
    public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
    {
        ...
        {
            throw new FormatException("Cannot parse Money", ex);
        }
    }
}
