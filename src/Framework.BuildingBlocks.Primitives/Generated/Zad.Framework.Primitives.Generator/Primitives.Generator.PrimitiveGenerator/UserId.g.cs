...
public sealed partial class UserId : IEquatable<UserId>
        , IComparable
        , IComparable<UserId>
        ...
        , IXmlSerializable
{
    ...
    /// <summary>Initializes a new instance of the <see cref="UserId"/> class by validating the specified <see cref="string"/> value using <see cref="Validate"/> static method.</summary>
    /// <param name="value">The value to be validated.</param>
    public UserId(string value) : this(value, true) { }

    private UserId(string value, bool validate) 
    {
        if (validate)
        {
...
#nullable enable
    ...
    /// <param name="value">The value to create UserId from</param>
    /// <param name="result">When this method returns, contains the created UserId if the conversion succeeded, or null if the conversion failed.</param>
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)] out UserId? result)
    {
    ...
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value,[NotNullWhen(true)]  out UserId? result, [NotNullWhen(false)]  out string? errorMessage)
    {
    ...
    public int CompareTo(object? obj)
    {
        ...
        {
            null => 1,
            UserId c => CompareTo(c),
            _ => throw new ArgumentException("Object is not a UserId", nameof(obj)),
        };
    }
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserId Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => s.ToString();

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserId Parse(string s, IFormatProvider? provider) => Parse(s.AsSpan(), provider);
    ...
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out UserId result)
    {
        ...
        return UserId.TryCreate(value, out result);
    }

    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out UserId result) => TryParse(s is null ? [] : s.AsSpan(), provider, out result);
    ...
    /// <summary>Implicit conversion from <see cref = "string"/> (nullable) to <see cref = "UserId"/> (nullable)</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator UserId?(string? value) => value is null ? null : new(value);

    /// <summary>Implicit conversion from <see cref = "UserId"/> (nullable) to <see cref = "string"/> (nullable)</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator string?(UserId? value) => value is null ? null : (string?)value._valueOrThrow;
