...
public sealed partial class AccountId : IEquatable<AccountId>
        , IComparable
        , IComparable<AccountId>
        , ISpanParsable<AccountId>
        , IConvertible
        , IXmlSerializable
{
    /// <inheritdoc/>
    ...
    /// <summary>Initializes a new instance of the <see cref="AccountId"/> class by validating the specified <see cref="string"/> value using <see cref="Validate"/> static method.</summary>
    /// <param name="value">The value to be validated.</param>
    public AccountId(string value) : this(value, true) { }

    private AccountId(string value, bool validate) 
    {
        if (validate)
        {
...
#nullable enable
    ...
    /// <param name="value">The value to create AccountId from</param>
    /// <param name="result">When this method returns, contains the created AccountId if the conversion succeeded, or null if the conversion failed.</param>
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)] out AccountId? result)
    {
    ...
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value,[NotNullWhen(true)]  out AccountId? result, [NotNullWhen(false)]  out string? errorMessage)
    {
    ...
    public int CompareTo(object? obj)
    {
        ...
        {
            null => 1,
            AccountId c => CompareTo(c),
            _ => throw new ArgumentException("Object is not a AccountId", nameof(obj)),
        };
    }
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccountId Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => s.ToString();

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccountId Parse(string s, IFormatProvider? provider) => Parse(s.AsSpan(), provider);

    /// <inheritdoc/>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out AccountId result)
    {
        ...
        return AccountId.TryCreate(value, out result);
    }

    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out AccountId result) => TryParse(s is null ? [] : s.AsSpan(), provider, out result);
    ...
    /// <summary>Implicit conversion from <see cref = "string"/> (nullable) to <see cref = "AccountId"/> (nullable)</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator AccountId?(string? value) => value is null ? null : new(value);

    /// <summary>Implicit conversion from <see cref = "AccountId"/> (nullable) to <see cref = "string"/> (nullable)</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator string?(AccountId? value) => value is null ? null : (string?)value._valueOrThrow;
