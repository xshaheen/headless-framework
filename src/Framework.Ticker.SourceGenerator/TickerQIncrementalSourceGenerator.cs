...
using System.Text;
using Framework.Ticker.SourceGenerator.AttributeSyntaxes;
using Framework.Ticker.SourceGenerator.Generators;
using Framework.Ticker.SourceGenerator.Utilities;
using Framework.Ticker.SourceGenerator.Validation;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.CSharp.Syntax;
using Microsoft.CodeAnalysis.Text;

namespace Framework.Ticker.SourceGenerator;
...
public sealed class TickerQIncrementalSourceGenerator : IIncrementalGenerator
{
    ...
    /// </summary>
    private static void _GenerateFileHeaderWithTickerQUsings(
        StringBuilder sb,
    ...
    )
    {
        ...
        sb.AppendLine("using Framework.Ticker.Utilities;");
        sb.AppendLine("using Framework.Ticker.Utilities.Enums;");

        // Include Base utilities if ToGenericContextWithRequest is used
        if (includeBaseUtilities)
        {
            sb.AppendLine("using Framework.Ticker.Utilities.Base;");
        }
            ...
            return constructorSymbol
                ...
                .Any(attr =>
                {
                    ...
                    return attributeName == "TickerQConstructorAttribute"
                        ...
                        || fullName == "Framework.Ticker.Utilities.TickerQConstructorAttribute"
                        || fullName == "Framework.Ticker.Utilities.TickerQConstructor";
                });
        });
