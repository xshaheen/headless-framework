...
internal class PulsarTransport(ILogger<PulsarTransport> logger, IConnectionFactory connectionFactory) : ITransport
{
    ...
    {
        var producer = await connectionFactory.CreateProducerAsync(message.GetName());
