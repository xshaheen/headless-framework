    ...
    private string _CreateDbTablesScript(string schema)
    {
        var batchSql = $"""
            ...
            CREATE TABLE IF NOT EXISTS {GetReceivedTableName()}(
                ...
                "Owner" VARCHAR({SetupMessaging.OwnerColumnMaxLength}) NULL,
            ...
            ALTER TABLE {GetReceivedTableName()} ADD COLUMN IF NOT EXISTS "Owner" VARCHAR({SetupMessaging.OwnerColumnMaxLength}) NULL;
            ALTER TABLE {GetPublishedTableName()} ADD COLUMN IF NOT EXISTS "Owner" VARCHAR({SetupMessaging.OwnerColumnMaxLength}) NULL;
