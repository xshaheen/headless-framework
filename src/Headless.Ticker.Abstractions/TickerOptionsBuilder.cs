    ...
    where TCronTicker : CronTickerEntity, new()
{
    ...
    internal TickerOptionsBuilder(
        TickerExecutionContext tickerExecutionContext,
    ...
    Func<IServiceProvider, Task>? ITickerOptionsSeeding.TimeSeederAction => TimeSeederAction;
    Func<IServiceProvider, Task>? ITickerOptionsSeeding.CronSeederAction => CronSeederAction;
    ...
    public TickerOptionsBuilder<TTimeTicker, TCronTicker> ConfigureScheduler(
    ...
    public TickerOptionsBuilder<TTimeTicker, TCronTicker> ConfigureRequestJsonOptions(
    ...
    public TickerOptionsBuilder<TTimeTicker, TCronTicker> SetExceptionHandler<THandler>()
