...
- **Two identities**: durable providers generate an internal numeric storage ID for retries and operator actions while `PublishOptions.MessageId` remains an arbitrary logical string
