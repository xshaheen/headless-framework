...
- **Provider Capabilities**: The protected metadata endpoint and footer disclosure show descriptor-backed transport lanes, independent-lane topology, and delayed-scheduling support without exposing broker resource names or credentials
