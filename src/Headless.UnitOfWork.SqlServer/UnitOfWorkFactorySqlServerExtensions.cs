...
/// <summary>
/// SqlClient entry points for the scoped unit of work: <c>BeginAsync(connection)</c> (owned mode — the unit
...
public static class UnitOfWorkFactorySqlServerExtensions
{
    extension(IUnitOfWorkFactory factory)
    {
        ...
        /// <summary>
        /// Enlists an already-open SqlClient transaction in observed mode: the caller commits (or rolls back) the
