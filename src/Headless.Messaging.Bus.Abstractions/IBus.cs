...
{
    /// <summary>
    /// Publishes a message to the configured bus transport using the resolved messageName.
    /// </summary>
    /// <typeparam name="T">The message type.</typeparam>
    /// <param name="contentObj">The message payload. Can be <see langword="null"/>.</param>
    /// <param name="options">Optional publish overrides for messageName, correlation, and custom headers.</param>
