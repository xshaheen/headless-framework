...
public sealed class SqlServerFeaturesFailureModesTests(SqlServerFeaturesFixture fixture) : TestBase
{
    [Fact]
    ...
    public async Task should_succeed_when_multiple_hosts_initialize_concurrently_against_same_schema()
    {
        ...
        try
        {
            ...
            (await _CountIndexesAsync("features_sql_concurrent")).Should().Be(6);
        }
        finally
        {
