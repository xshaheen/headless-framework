...
[CollectionDefinition(nameof(OutputCacheRedisFixture), DisableParallelization = false)]
public sealed class OutputCacheRedisFixture : HeadlessRedisFixture, ICollectionFixture<OutputCacheRedisFixture>
{
