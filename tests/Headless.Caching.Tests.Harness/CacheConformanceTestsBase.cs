...
public abstract class CacheConformanceTestsBase : TestBase
{
    ...
    public virtual async Task should_raise_set_and_hit_events_on_contract_operations()
    {
        ...
        using var _1 = cache.Events.Set.AddHandler(e => sets.Add(e));
        using var _2 = cache.Events.Hit.AddHandler(e => hits.Add(e));
    ...
    public virtual async Task should_raise_remove_event_on_contract_remove()
    {
        ...
        using var _ = cache.Events.Remove.AddHandler(e => removes.Add(e));
