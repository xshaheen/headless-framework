...
/// <see langword="null"/>. The "registration" scenarios pin the opt-out and the once-only wrap.
/// </summary>
...
/// <summary>Links generated by one request; <see langword="null"/> means the surface could not build the link.</summary>
