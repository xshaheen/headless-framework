...
public sealed class SqlServerCronMaterializationTests(JobsKeyLockSqlServerFixture fixture)
    : JobsCronMaterializationConformanceTests(options => options.UseSqlServer(fixture.ConnectionString))
{
    [Fact]
