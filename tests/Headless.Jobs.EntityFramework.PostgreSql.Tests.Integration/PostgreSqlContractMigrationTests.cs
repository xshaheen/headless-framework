...
public sealed class PostgreSqlContractMigrationTests(PostgreSqlJobsCoordinationFixture fixture)
    : JobsContractMigrationConformanceTests<PostgreSqlJobsCoordinationFixture>(fixture)
{
