...
/// <summary>Runs the Jobs tenant-propagation conformance suite against Postgres.</summary>
[Collection<PostgreSqlJobsCoordinationFixture>]
public sealed class PostgreSqlTenancyTests(PostgreSqlJobsCoordinationFixture fixture)
    : JobsTenancyConformanceTests<PostgreSqlJobsCoordinationFixture>(fixture)
{
    [Fact]
