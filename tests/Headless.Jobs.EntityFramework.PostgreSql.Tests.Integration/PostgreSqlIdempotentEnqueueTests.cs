...
public sealed class PostgreSqlIdempotentEnqueueTests(PostgreSqlJobsCoordinationFixture fixture)
    : JobsIdempotentEnqueueConformanceTests<PostgreSqlJobsCoordinationFixture>(fixture)
{
    [Fact]
