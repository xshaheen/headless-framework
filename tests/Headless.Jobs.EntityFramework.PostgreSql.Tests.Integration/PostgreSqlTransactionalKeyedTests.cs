...
public sealed class PostgreSqlTransactionalKeyedTests(PostgreSqlJobsCoordinationFixture fixture)
    : JobsTransactionalKeyedConformanceTests<PostgreSqlJobsCoordinationFixture>(fixture)
{
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
