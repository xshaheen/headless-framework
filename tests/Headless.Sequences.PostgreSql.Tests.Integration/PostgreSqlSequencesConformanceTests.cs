...
public sealed class PostgreSqlSequencesConformanceTests(PostgreSqlSequencesFixture fixture)
    : SequencesConformanceTests<PostgreSqlSequencesFixture>(fixture)
{
    [Fact]
