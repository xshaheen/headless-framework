...
public sealed class PostgreSqlFeaturesFailureModesTests(PostgreSqlFeaturesFixture fixture)
{
    [Fact]
    ...
    public async Task should_succeed_when_multiple_hosts_initialize_concurrently_against_same_schema()
    {
        ...
        var hosts = Enumerable.Range(0, hostCount).Select(_ => _CreateHost(fixture.ConnectionString, "features_pg_concurrent")).ToArray();
