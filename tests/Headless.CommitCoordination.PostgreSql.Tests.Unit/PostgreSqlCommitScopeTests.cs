...
/// <summary>
/// The explicit-signal contract of a directly enlisted PostgreSQL transaction, isolated from Npgsql: the
/// transaction's completion is a delegate, so the forgotten-signal warning is asserted without a server.
/// </summary>
public sealed class PostgreSqlCommitScopeTests : TestBase
{
    [Fact]
    ...
    private sealed class Harness
    {
        ...
        public CapturingLogger<PostgreSqlCommitScope> Logger { get; } = new();
        ...
        public Harness(bool transactionCompleted)
        {
            ...
            Scope = new PostgreSqlCommitScope(inner, () => transactionCompleted, Logger);
        }
    }
}
