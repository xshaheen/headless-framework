...
public sealed class PublishOptionsBuilderTests : TestBase
{
    [Fact]
    ...
    public void should_merge_ordinal_headers_and_isolate_inputs_builder_and_each_snapshot()
    {
        ...
        var builder = new PublishOptionsBuilder().WithHeaders(input);
    ...
    public void should_enumerate_headers_at_the_mutator_boundary()
    {
        ...
        var builder = new PublishOptionsBuilder().WithHeaders(headers());
