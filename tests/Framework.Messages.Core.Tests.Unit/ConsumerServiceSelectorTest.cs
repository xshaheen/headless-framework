...
public class ConsumerServiceSelectorTest
{
    ...
    public ConsumerServiceSelectorTest()
    {
        ...
        services.AddOptions();
        services.PostConfigure<CapOptions>(_ => { });
    ...
    public void CanFindAllConsumerService()
    {
        ...
        candidates.Should().HaveCount(13);
    }
    ...
    public void CanFindSpecifiedTopic(string topic)
    {
        ...
        bestCandidates.Should().NotBeNull();
        bestCandidates.MethodInfo.Should().NotBeNull();
    ...
    public void CanFindTopicSuccessfully(string topic, int parameterCount, int fromCapCount)
    {
        ...
        bestCandidate.Should().NotBeNull();
...
public sealed class CandidatesTopic(string topicName, bool isPartial = false) : TopicAttribute(topicName, isPartial);
...
public class CandidatesFooTest : IFooTest, IConsumer
{
...
/// </summary>
public abstract class CandidatesAbstractBaseTest : IConsumer, IAbstractTest
{
...
[CandidatesTopic("Candidates")]
public class CancellationTokenTest : ICancellationTest, IConsumer
{
    ...
    public Task OneAdditionalParameter([FromCap] MessageHeader headers, CancellationToken cancellationToken)
    {
    ...
    public Task CommonArrangement(
        DateTime date,
        [FromCap] IDictionary<string, string> headers,
