...
public class MessagingBuilderTests
{
    ...
    [Fact]
    public void should_throw_when_consumer_does_not_implement_iconsume()
    {
        // Given
        var services = new ServiceCollection();
...
{
    public ValueTask Consume(ConsumeContext<TestOrderMessage> context, CancellationToken cancellationToken = default)
    {
...
{
    public ValueTask Consume(ConsumeContext<TestPaymentMessage> context, CancellationToken cancellationToken = default)
    {
        return ValueTask.CompletedTask;
    }
}
