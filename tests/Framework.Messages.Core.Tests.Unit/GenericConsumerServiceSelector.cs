...
public class GenericConsumerServiceSelector<TSubscriber, TSubscriptionAttribute>(IServiceProvider serviceProvider)
        ...
        foreach (var method in typeInfo.DeclaredMethods)
        {
            ...
            foreach (var attr in topicAttributes)
            {
                ...
                yield return new ConsumerExecutorDescriptor
                {
                    ...
                    Parameters = _GetParameterDescriptors(method).ToList(),
                };
            }
        }
    }
