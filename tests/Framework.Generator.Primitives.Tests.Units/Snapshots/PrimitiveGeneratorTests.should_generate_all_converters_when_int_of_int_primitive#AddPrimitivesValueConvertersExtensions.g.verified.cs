...
public static class AddPrimitivesValueConvertersExtensions
{
    ...
    {
        configurationBuilder.Properties<IntPrimitive>().HaveConversion<IntPrimitiveValueConverter>();
        configurationBuilder.Properties<IntOfIntPrimitive>().HaveConversion<IntOfIntPrimitiveValueConverter>();
