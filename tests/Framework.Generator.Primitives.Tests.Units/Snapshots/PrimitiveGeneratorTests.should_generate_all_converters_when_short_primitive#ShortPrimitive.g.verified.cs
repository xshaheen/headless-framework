...
[JsonConverter(typeof(ShortPrimitiveJsonConverter))]
...
#pragma warning restore AL1003
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ShortPrimitive Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => short.Parse(s, provider);

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ShortPrimitive Parse(string s, IFormatProvider? provider) => Parse(s.AsSpan(), provider);

    /// <inheritdoc/>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out ShortPrimitive result)
    {
    ...
    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out ShortPrimitive result) => TryParse(s is null ? [] : s.AsSpan(), provider, out result);
