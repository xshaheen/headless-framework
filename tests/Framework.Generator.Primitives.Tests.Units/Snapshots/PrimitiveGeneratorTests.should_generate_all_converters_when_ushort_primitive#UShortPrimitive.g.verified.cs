...
[JsonConverter(typeof(UShortPrimitiveJsonConverter))]
[TypeConverter(typeof(UShortPrimitiveTypeConverter))]
[UnderlyingPrimitiveType(typeof(ushort))]
[DebuggerDisplay("{" + nameof(_value) + "}")]
public readonly partial struct UShortPrimitive : IEquatable<UShortPrimitive>
        , IComparable
        , IComparable<UShortPrimitive>
        , IComparisonOperators<UShortPrimitive, UShortPrimitive, bool>
        , ISpanParsable<UShortPrimitive>
        , IConvertible
        , IXmlSerializable
...
#pragma warning restore AL1003
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UShortPrimitive Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => ushort.Parse(s, provider);

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UShortPrimitive Parse(string s, IFormatProvider? provider) => Parse(s.AsSpan(), provider);

    /// <inheritdoc/>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out UShortPrimitive result)
    {
    ...
    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out UShortPrimitive result) => TryParse(s is null ? [] : s.AsSpan(), provider, out result);
