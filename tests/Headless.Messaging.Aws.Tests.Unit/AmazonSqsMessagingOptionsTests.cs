...
public sealed class AmazonSqsMessagingOptionsTests
{
    [Fact]
    public void should_require_region()
    {
        // given, when
        var options = new AmazonSqsMessagingOptions { Region = RegionEndpoint.USEast1 };
    ...
    {
        // given, when
        var usEast = new AmazonSqsMessagingOptions { Region = RegionEndpoint.USEast1 };
        var euWest = new AmazonSqsMessagingOptions { Region = RegionEndpoint.EUWest1 };
        var apSouth = new AmazonSqsMessagingOptions { Region = RegionEndpoint.APSouth1 };
    ...
    public void should_allow_custom_credentials()
    {
        ...
        // when
        var options = new AmazonSqsMessagingOptions { Region = RegionEndpoint.USEast1, Credentials = credentials };
