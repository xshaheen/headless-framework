...
public static class AddSwashbuckleSwaggerPrimitivesMappingsExtensions
{
    ...
    /// <see cref="StringPrimitive" />
    /// <see cref="StringOfStringPrimitive" />
    /// </remarks>
    public static void AddSwaggerPrimitiveMappings(this SwaggerGenOptions options)
    {
        options.MapType<StringPrimitive>(() => new OpenApiSchema
        {
            Type = "string",
            Title = "StringPrimitive"
        });
        options.MapType<StringOfStringPrimitive>(() => new OpenApiSchema
        {
            Type = "string",
            Title = "StringOfStringPrimitive"
        });
    }
}
