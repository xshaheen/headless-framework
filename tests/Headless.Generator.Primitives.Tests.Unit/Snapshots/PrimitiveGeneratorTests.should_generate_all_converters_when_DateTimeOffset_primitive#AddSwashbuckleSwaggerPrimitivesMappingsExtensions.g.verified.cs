...
public static class AddSwashbuckleSwaggerPrimitivesMappingsExtensions
{
    ...
    /// <see cref="DateTimeOffsetPrimitive" />
    /// </remarks>
    public static void AddSwaggerPrimitiveMappings(this SwaggerGenOptions options)
    {
        options.MapType<DateTimeOffsetPrimitive>(() => new OpenApiSchema
        {
            Type = "string",
            Format = "date-time",
            Title = "DateTimeOffsetPrimitive"
        });
        options.MapType<DateTimeOffsetPrimitive?>(() => new OpenApiSchema
        {
            Type = "string",
            Format = "date-time",
            Nullable = true,
            Title = "Nullable<DateTimeOffsetPrimitive>"
        });
    }
}
