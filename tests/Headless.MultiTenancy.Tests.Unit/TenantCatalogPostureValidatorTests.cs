...
public sealed class TenantCatalogPostureValidatorTests
{
    ...
    /// <summary>
    /// Marks the status-codes rewriter by default so the tests above isolate the posture rules they
    /// target; pass <see langword="false"/> to exercise the missing-rewriter rule.
    /// </summary>
