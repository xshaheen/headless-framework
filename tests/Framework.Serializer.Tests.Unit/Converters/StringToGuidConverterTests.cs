...
public class StringToGuidConverterTests
{
    ...
    public void string_to_guid_converter_should_return_valid_guid_given_valid_guid_in_different_formats(string guidString, string format)
    {
        // given
        var json = $"\"{guidString}\"";
    ...
    [InlineData("(d85b1407-351d-4694-9392-03acc5870eb1)", "P")]
    [InlineData("{0xD85B1407,0x351D,0x4694,{0x93,0x92,0x03,0xAC,0xC5,0x87,0x0E,0xB1}}", "X")]
    public void string_to_guid_converter_should_serialize_the_guid_formats_successfully(string guidString, string format)
    {
        // given
