...
public sealed class RequireEnvironmentAttributeTests : TestBase
{
    [Fact]
    public async Task should_allow_in_matching_environment()
    {
        // given
    ...
    [Fact]
    public async Task should_block_in_non_matching_environment()
    {
        // given
        var attribute = new RequireEnvironmentAttribute("Development");
