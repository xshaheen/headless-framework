...
public sealed class ApiSurfaceConventionTests : TestBase
{
    ...
    [Fact]
    public void should_apply_prefix_group_policy_and_tenancy_to_controller()
    {
        ...
        var convention = new ApiSurfaceConvention(options);
        ...
        controllerModel.ApiExplorer.GroupName.Should().Be("Portal");
