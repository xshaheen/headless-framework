...
| [Headless.Messaging.Storage.PostgreSql.EntityFramework](src/Headless.Messaging.Storage.PostgreSql.EntityFramework/README.md) | ربط تخزين PostgreSQL بسياق EF Core وصندوق الصادر المعاملي |
| [Headless.Messaging.Storage.SqlServer](src/Headless.Messaging.Storage.SqlServer/README.md) | تخزين الرسائل في SQL Server |
| [Headless.Messaging.Storage.SqlServer.EntityFramework](src/Headless.Messaging.Storage.SqlServer.EntityFramework/README.md) | ربط تخزين SQL Server بسياق EF Core وصندوق الصادر المعاملي |
| [Headless.Messaging.Storage.InMemory](src/Headless.Messaging.Storage.InMemory/README.md) | تخزين مؤقت داخل الذاكرة |
